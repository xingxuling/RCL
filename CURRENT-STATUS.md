...
K08-R BF16 GQA+RoPE multi-block is `BF16_GQA_ROPE_MULTIBLOCK_REFERENCE_CANDIDATE_LOCAL_ONLY`. On main `a095872beca5d61a3ffde99f31e7163dc54a4dbb`, the existing K08-N/K08-O/K08-R two-block generic graph now executes through K08-S BF16 RNE, FP32 accumulation, Reverse Autodiff and exact FP32 AdamW. All fourteen canonical parameter groups update; loss decrease, deterministic replay and exact direct `6 == checkpoint 3 + resume 3` pass in `6/6` local tests. Hosted gap: `RCL_GAP_K08_R_BF16_HOSTED_REPLAY`. No GPU/OpenCL/Vulkan, RCL-10M, RCL-1B or K400 claim is granted. Authority: `docs/native-ai/bf16-gqa-rope-multiblock-evidence-v0.1.md`, `examples/native-ai/bf16-gqa-rope-multiblock-contract.v0.1.json` and `examples/native-ai/evidence/bf16-gqa-rope-multiblock-v0.1/k08-r-bf16-local-evidence.json`.
