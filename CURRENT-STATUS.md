...
Current authoritative matrix: `20 PASS / 0 BLOCKED / 380 UNTESTED`; maturity `U3`; K400 verdict `INCOMPLETE`. The PASS cells are K063, K064, K078, K083, K085, K098, K124, K138, K233, K321, K322, K326, K327, K329, K332, K333, K337, K338, K339 and K340.

K336 is a local candidate for one bounded governed-automation compiler profile. Twenty native rounds preserve one artifact hash and semantic-state root, match an independent JavaScript dependency/retry/approval/kill-switch/compensation oracle and reject four semantic mutations plus corrupt RBC. Three unique read-only ephemeral sessions restore dependency, retry and approval mutations to exact canonical bytes. It remains `UNTESTED` until focused Linux and Windows GitHub authority is bound; no external-action, production scheduler or durable-queue claim is granted.
