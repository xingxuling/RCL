...
steps.push(
  ...
  { code: 41, name: 'strict-federation-extension', args: ['scripts/verify-vercel-foundation-native-federation-extension.mjs'] },
  { code: 42, name: 'physical-real-c', args: ['scripts/verify-vercel-foundation-physical.mjs'] },
  { code: 43, name: 'neural-real-c', args: ['scripts/verify-vercel-foundation-neural.mjs'] },
  { code: 44, name: 'neural-deployment-binding', args: ['scripts/bind-vercel-foundation-neural.mjs'] },
  ...
  { code: 48, name: 'federation-deployment-binding', args: ['scripts/bind-vercel-foundation-native-federation.mjs'] },
  { code: 49, name: 'federation-root-stabilization', args: ['scripts/stabilize-vercel-foundation-native-federation-root.mjs'] },
  { code: 50, name: 'bridge-registry-verification', args: ['scripts/verify-foundation-native-bridge-capability-registry.mjs'] },
  { code: 51, name: 'quantitative-direct-deployment-binding', args: ['scripts/bind-vercel-foundation-quantitative-direct.mjs'] },
  { code: 52, name: 'quantitative-direct-health', args: ['scripts/verify-vercel-foundation-quantitative-direct-health.mjs'] },
  { code: 53, name: 'deployment-health', args: ['scripts/verify-vercel-health-evidence.mjs'] },
);
