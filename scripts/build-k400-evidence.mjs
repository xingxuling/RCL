...
const evidence = {
  ...
  sourceReceipts: [nativeUiPath, k02Path, k03Path, k08Path, k233ReceiptPath, k233GithubReplayPath, k08TensorMlpPath, k08TensorMlpGithubReplayPath, browserPerformanceContractPath, browserRuntimePath],
  notes: [
