...
try {
  const baseline = runtimeHealthStatus();
  ...
  const registryDrift = runtimeHealthStatus({ bridgeStatePathSurface: wrongRegistry });
  ...
  const overclaimDrift = runtimeHealthStatus({ bridgeStatePathSurface: overclaim });
  ...
  const missingRootDrift = runtimeHealthStatus({ bridgeStatePathSurface: missingRoot });
