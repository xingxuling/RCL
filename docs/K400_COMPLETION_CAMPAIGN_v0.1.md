...
| `K326` | `compiler-runtime::database` | `UNTESTED` | local 20-round native and 3/3 independent-repair candidate exists; exact GitHub focused and Windows authority remains required |
