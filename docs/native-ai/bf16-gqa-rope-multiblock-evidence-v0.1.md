...
`BF16_GQA_ROPE_MULTIBLOCK_REFERENCE_CANDIDATE_GITHUB_REPLAY_BOUND`
...
|---|---|---|
| `RCL_GAP_K08_R_BF16_HOSTED_REPLAY` | CLOSED_FOR_THIS_CANDIDATE | run `32989948133` passed Ubuntu and Windows on exact head `3716f51` |
