...
`GitHub replay of borrowed-input/process-memory evidence -> buffer reuse and compact lowering -> typed self-host lowering -> scientific-number root closure -> native Autodiff`.
