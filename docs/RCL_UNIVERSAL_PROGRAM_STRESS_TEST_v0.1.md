...
The seventeen admitted cells are K063, K064, K078, K083, K085, K098, K124, K138, K233, K321, K322, K327, K333, K337, K338, K339 and K340. K124/K138 are limited to the generated Node loopback profile; K233 is limited to the bounded two-Dense-layer General MLP profile; K321/K322 are limited to the frozen recursive-algorithm native CLI profile; K327 is limited to its three builtin-lowering repairs and separately admitted compiler-runtime binding; K333 is limited to its bounded integer-perceptron advisory profile; K337/K338 are limited to the bounded two-transaction compiler-governance profile; K340 is limited to its frozen recursive + declarative + transactional + reactive native profile. The K333 floating-point state-root and self-host static warrant-validation gaps remain open. Tensor Genome promotion, optimizer genome, Transformer, accelerated backends, public server deployment and the remaining 383 matrix cells remain outside this evidence. See `docs/K400_COMPLETION_CAMPAIGN_v0.1.md` and `docs/K08_RCL_NATIVE_AI_CAMPAIGN_v0.1.md`.
