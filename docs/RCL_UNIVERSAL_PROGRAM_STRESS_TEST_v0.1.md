...
The twenty admitted cells are K063, K064, K078, K083, K085, K098, K124, K138, K233, K321, K322, K326, K327, K329, K332, K333, K337, K338, K339 and K340. K124/K138 are limited to the generated Node loopback profile; K233 is limited to the bounded two-Dense-layer General MLP profile; K321/K322 are limited to the frozen recursive-algorithm native CLI profile; K326 is limited to one bounded in-memory relational query and atomic-insert profile; K327 is limited to its three builtin-lowering repairs and separately admitted compiler-runtime binding; K329/K332 are limited to one integer constant-acceleration trajectory, closed-form oracle and discrete invariant; K333 is limited to its bounded integer-perceptron advisory profile; K337/K338 are limited to the bounded two-transaction compiler-governance profile; K340 is limited to its frozen recursive + declarative + transactional + reactive native profile. The K326 durable/concurrent relational-runtime gap, K333 floating-point state-root gap and self-host static warrant-validation gap remain open. SQL engines, persistence, concurrency, floating-point solvers, arbitrary physics, Tensor Genome promotion, optimizer genome, Transformer, accelerated backends, public server deployment and the remaining 380 matrix cells remain outside this evidence. See `docs/K400_COMPLETION_CAMPAIGN_v0.1.md` and `docs/K08_RCL_NATIVE_AI_CAMPAIGN_v0.1.md`.
